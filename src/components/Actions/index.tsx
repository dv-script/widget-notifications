...
export default function Actions({ clicked }:ActionsProps) {
    return (
        <div className="flex gap-2 self-center">
            ...
            <button className="w-8 h-8 rounded flex items-center justify-center bg-violet-500 hover:bg-violet-400" onClick={clicked}>
